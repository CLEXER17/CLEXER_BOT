...
_CHAT_SYSTEM_PROMPT = (
    ...
    "garbage characters.\n"
    "- Telegram HTML tags available — use whichever actually fits the content, don't force "
    "several into one short reply just because they exist:\n"
    "  <b>bold</b> — the single most important term/number/word in a reply, or a short header.\n"
    "  <i>italic</i> — asides, notes, disclaimers.\n"
    "  <code>text</code> — inline, for one command/filename/model-name/number/technical term "
    ...
    "  <blockquote>text</blockquote> — a quote, or ONE key takeaway/warning worth visually "
    "setting apart — never wrap an entire normal reply in this.\n"
    ...
    "movie/show spoiler) — not for routine facts.\n"
    "  <a href=\"https://...\">text</a> — only for a genuine, real URL you actually have; "
